...
public class p2pClient5 {

		public void p2pClient5() {}
		...
		private static class CtoSrequest extends Thread
		{
			...
			public void run()
			{
				try{
				    ...
				    chunk.add(chunkname); 
					System.out.println("Client5 has received chunk number " + chunkname);
					...
					File outputfiledir = new File("e:/2015fall/computer network/project/client5/data");
                    if(!outputfiledir.exists())
					{
					      outputfiledir.mkdirs();
			        }
                    // System.out.println("run3 ");
                    File outputfile = new File("e://2015fall/computer network/project/client5/data/" + chunkname +".pdf");
...
//								}
								...
								sendMessage(message);	
								System.out.println("Client5 has sent chunks  " + message + "to Client "+ clientNum);
							}
						   }
...
//		}
		...
		public static void main(String args[]) throws Exception 
		{
			...
			int c = 5;   // define this is client1;
			p2pClient5 client1 = new p2pClient5();
			CtoSrequest ctos1 = new CtoSrequest("localhost", 8085);
			...
			ServerSocket server = new ServerSocket(8050);  // listen to port 8012
			while (true) {  
		         //accept  
		         Socket socket = server.accept();  
		         //every time recevie a new socket;  
		         System.out.println("c1 run2");
		         new Thread(new Task(socket,8050,5)).start();  
		         System.out.println("c1 run3");
		      }  
