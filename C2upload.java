...
public class C2upload {

	public void C2upload(){}
...
//				}
		...
		//System.out.println(existfileid.get(100));
		return existfileid;
	}
	...
	{   
		...
		public C2(String host1, int port1)
		{
			this.host = host1;
			this.cport = port1;
		}
...
//					}
		...
		void sendRequest(int cnum)
		{
		 try{
			...
			System.out.println("Client2 has connected with client " +cnum + "in port "+ cport);
			...
			for(int i=0;i< need.size();i++)                      //write file
			{
			  ...
			  File inputfile = new File((String) ("e://2015fall/computer network/project/client2/data/"+need.get(i)));
...
//	}
	...
	public static void main(String args[]) throws Exception 
	{
		...
		C2upload client2 = new C2upload();
		int sizeall = client2.checkfilenum();
		
		//connect with Server1;
		Boolean flag = true;
		while(flag)
		{
		C2 c1to2 = new C2("localhost", 8020);
		c1to2.sendRequest(1);
		C2 c1to5 = new C2("localhost", 8020);
		c1to5.sendRequest(3);
		...
		String[] allin1=new String[client2.checkfilecompare("e://2015fall/computer network/project/client1/data").size()]; 
		for(int i=0;i<client2.checkfilecompare("e://2015fall/computer network/project/client1/data").size();i++)
		{     
			      System.out.println("c1 run5");
			      allin1[i]=(String)client2.checkfilecompare("e://2015fall/computer network/project/client1/data").get(i);  
		}  
		String[] allin3=new String[client2.checkfilecompare("e://2015fall/computer network/project/client3/data").size()]; 
		for(int i=0;i<client2.checkfilecompare("e://2015fall/computer network/project/client3/data").size();i++)
		{     
				      System.out.println("c1 run5");
				      allin3[i]=(String)client2.checkfilecompare("e://2015fall/computer network/project/client3/data").get(i);  
		}  
		 if(Arrays.equals(all,allin1) && Arrays.equals(all,allin3))
		 {
			 flag = false;
			 
			 client2.combine("e://2015fall/computer network/project/client1/data/");
			 client2.combine("e://2015fall/computer network/project/client3/data/");
		 }
