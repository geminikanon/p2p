		...
		private static class CtoSrequest extends Thread
		{
			...
			public void run()
			{
				try{
					...
					File outputfiledir = new File("e:/2015fall/computer network/project/client1/data");
                    if(!outputfiledir.exists())
					{
					      outputfiledir.mkdirs();
			        }
                    // System.out.println("run3 ");
                    File outputfile = new File("e://2015fall/computer network/project/client1/data/" + chunkname +".pdf");
...
//		}
		...
		public static void main(String args[]) throws Exception 
		{
			...
			int c = 1;   // define this is client1;
			p2pClient1 client1 = new p2pClient1();
			CtoSrequest ctos1 = new CtoSrequest("localhost", 8081);
			...
			ServerSocket server = new ServerSocket(8010);  // listen to port 8012
			while (true) {  
		         //accept  
		         Socket socket = server.accept();  
		         //every time recevie a new socket;  
		         System.out.println("c1 run2");
		         new Thread(new Task(socket,8010,1)).start();  
		         System.out.println("c1 run3");
		      }  
