...
//					}
		...
		String makeMsg(ArrayList filelist)
		{
			...
			System.out.println("The size of whole files is "+ size);
		...
		void sendRequest(int cnum)
		{
		 try{
			...
			System.out.println("Client1 has connected with client " +cnum + "in port "+ cport);
			...
			System.out.println("Client "+ cnum+ " needs chunk number " + message);
			sendMessage(message);
			response = (String)in.readObject(); //get response from server;
			System.out.println("Client 1 has sent chunk number " + response+" to Client " + cnum);
			...
			else
			{
				...
				if(response != "none" && !"".equals(response))
			    {
...
//					    {
//					         need.add(response.charAt(i) + ".pdf");
//					    }
//					}
//				}
			}
			...
			for(int i=0;i< need.size();i++)                      //write file
			{
			  ...
			  File inputfile = new File((String) ("e://2015fall/computer network/project/client1/data/"+need.get(i)));
...
//	}
	...
	public static void main(String args[]) throws Exception 
	{
		...
		while(flag)
		{
		C1 c1to2 = new C1("localhost", 8010);
		c1to2.sendRequest(2);
		C1 c1to5 = new C1("localhost", 8010);
		c1to5.sendRequest(5);
		...
		String[] allin2=new String[client1.checkfilecompare("e://2015fall/computer network/project/client2/data").size()]; 
		for(int i=0;i<client1.checkfilecompare("e://2015fall/computer network/project/client2/data").size();i++)
		{     
			      System.out.println("c1 run5");
			      allin2[i]=(String)client1.checkfilecompare("e://2015fall/computer network/project/client2/data").get(i);  
		}  
		String[] allin5=new String[client1.checkfilecompare("e://2015fall/computer network/project/client5/data").size()]; 
		for(int i=0;i<client1.checkfilecompare("e://2015fall/computer network/project/client5/data").size();i++)
		{     
				      System.out.println("c1 run5");
				      allin5[i]=(String)client1.checkfilecompare("e://2015fall/computer network/project/client5/data").get(i);  
		}  
