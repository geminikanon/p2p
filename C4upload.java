...
public class C4upload {

	public void C4upload(){}
...
//					}
		...
		void sendRequest(int cnum)
		{
		 try{
			...
			System.out.println("Client4 has connected with client " +cnum + "in port "+ cport);
			...
			for(int i=0;i< need.size();i++)                      //write file
			{
			  ...
			  File inputfile = new File((String) ("e://2015fall/computer network/project/client4/data/"+need.get(i)));
...
//	}
	...
	public static void main(String args[]) throws Exception 
	{
		...
		while(flag)
		{
		C1 c1to2 = new C1("localhost", 8040);
		c1to2.sendRequest(3);
		C1 c1to5 = new C1("localhost", 8040);
		c1to5.sendRequest(5);
		...
		String[] allin2=new String[client1.checkfilecompare("e://2015fall/computer network/project/client3/data").size()]; 
		for(int i=0;i<client1.checkfilecompare("e://2015fall/computer network/project/client3/data").size();i++)
		{     
			      System.out.println("c1 run5");
			      allin2[i]=(String)client1.checkfilecompare("e://2015fall/computer network/project/client3/data").get(i);  
		}  
		...
		{     
		 ...
		 if(Arrays.equals(all,allin2) && Arrays.equals(all,allin5))
		 {
			 ...
			 client1.combine("e://2015fall/computer network/project/client3/data/");
