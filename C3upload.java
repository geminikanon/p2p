...
public class C3upload {

	public void C3upload(){}
...
//					}
		...
		void sendRequest(int cnum)
		{
		 try{
			...
			System.out.println("Client3 has connected with client " +cnum + "in port "+ cport);
			...
			for(int i=0;i< need.size();i++)                      //write file
			{
			  ...
			  File inputfile = new File((String) ("e://2015fall/computer network/project/client3/data/"+need.get(i)));
...
//	}
	...
	public static void main(String args[]) throws Exception 
	{
		...
		while(flag)
		{
		C1 c1to2 = new C1("localhost", 8030);
		c1to2.sendRequest(2);
		C1 c1to5 = new C1("localhost", 8030);
		c1to5.sendRequest(4);
		...
		String[] allin5=new String[client1.checkfilecompare("e://2015fall/computer network/project/client4/data").size()]; 
		for(int i=0;i<client1.checkfilecompare("e://2015fall/computer network/project/client4/data").size();i++)
		{     
				      System.out.println("c1 run5");
				      allin5[i]=(String)client1.checkfilecompare("e://2015fall/computer network/project/client4/data").get(i);  
		}  
		 if(Arrays.equals(all,allin2) && Arrays.equals(all,allin5))
		 {
			 ...
			 client1.combine("e://2015fall/computer network/project/client4/data/");
		 }
