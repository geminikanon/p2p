		...
		private static class CtoSrequest extends Thread
		{
			...
			public void run()
			{
				try{
					...
					File outputfiledir = new File("e:/2015fall/computer network/project/client3/data");
                    if(!outputfiledir.exists())
					{
					      outputfiledir.mkdirs();
			        }
                    // System.out.println("run3 ");
                    File outputfile = new File("e://2015fall/computer network/project/client3/data/" + chunkname+".pdf");
...
//								}
								...
								sendMessage(message);	
								System.out.println("Client1 has  " + message);
							}
						   }
...
//		}
		...
		public static void main(String args[]) throws Exception 
		{
			...
			int c = 3;   // define this is client1;
			p2pClient3 client1 = new p2pClient3();
			CtoSrequest ctos1 = new CtoSrequest("localhost", 8083);
			...
			// handle new socket from client 2, which port number is 8030
			ServerSocket server = new ServerSocket(8030);  // listen to port 8012
			while (true) {  
		         //accept  
		         Socket socket = server.accept();  
		         //every time recevie a new socket;  
		         System.out.println("c1 run2");
		         new Thread(new Task(socket,8030,3)).start();  
		         System.out.println("c1 run3");
		      }  
